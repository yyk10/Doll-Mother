...
ActiveRecord::Schema.define(version: 2023_03_05_111011) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["clothe_id"], name: "index_bookmarks_on_clothe_id"
    t.index ["user_id", "clothe_id"], name: "index_bookmarks_on_user_id_and_clothe_id", unique: true
  ...
  add_foreign_key "bookmarks", "clothes"
